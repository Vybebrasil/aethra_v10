...
(function initSpriteLoader(Aethra) {
    ...
    const PIXEL_SPRITES = {
        ...
        templar: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="10" y="3" width="12" height="10" rx="2" fill="%23f1c40f"/><rect x="12" y="6" width="8" height="3" fill="%23ffffff"/><rect x="8" y="13" width="16" height="14" rx="2" fill="%23d4ac0d"/><rect x="4" y="11" width="5" height="16" rx="1" fill="%23f39c12"/><rect x="24" y="8" width="4" height="20" fill="%23ecf0f1"/></svg>`,
        goblin: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="10" y="6" width="12" height="10" rx="2" fill="%2327ae60"/><polygon points="4,6 10,8 8,12" fill="%2327ae60"/><polygon points="28,6 22,8 24,12" fill="%2327ae60"/><rect x="12" y="9" width="3" height="3" fill="%23f1c40f"/><rect x="17" y="9" width="3" height="3" fill="%23f1c40f"/><rect x="9" y="16" width="14" height="12" rx="2" fill="%236e2c00"/><rect x="23" y="14" width="3" height="12" fill="%23bdc3c7"/></svg>`,
        wolf: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M4 22 L12 8 L22 8 L28 22 Z" fill="%23566573"/><polygon points="8,4 12,9 6,10" fill="%2334495e"/><polygon points="20,4 24,10 18,9" fill="%2334495e"/><rect x="10" y="11" width="3" height="3" fill="%23e74c3c"/><rect x="19" y="11" width="3" height="3" fill="%23e74c3c"/><rect x="22" y="18" width="9" height="7" rx="2" fill="%232c3e50"/></svg>`,
        skeleton: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="10" y="4" width="12" height="10" rx="3" fill="%23ecf0f1"/><rect x="12" y="7" width="3" height="4" fill="%2317202a"/><rect x="17" y="7" width="3" height="4" fill="%2317202a"/><rect x="14" y="14" width="4" height="14" fill="%23bdc3c7"/><rect x="7" y="16" width="18" height="3" fill="%23ecf0f1"/><rect x="24" y="10" width="3" height="18" fill="%237f8c8d"/></svg>`,
        rat: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><ellipse cx="16" cy="20" rx="10" ry="7" fill="%236e2c00"/><circle cx="10" cy="16" r="4" fill="%2385929e"/><circle cx="8" cy="13" r="3" fill="%23f1948a"/><rect x="6" y="16" width="2" height="2" fill="%23e74c3c"/><path d="M26 21 C29 21 31 23 30 27" stroke="%23f1948a" stroke-width="2.5" fill="none"/></svg>`,
        boss: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M8 2 L12 9 L6 10 Z" fill="%23c0392b"/><path d="M24 2 L26 10 L20 9 Z" fill="%23c0392b"/><rect x="9" y="8" width="14" height="11" rx="2" fill="%23922b21"/><rect x="11" y="11" width="3" height="3" fill="%23f1c40f"/><rect x="18" y="11" width="3" height="3" fill="%23f1c40f"/><rect x="7" y="19" width="18" height="12" rx="3" fill="%23641e16"/><path d="M2 12 Q-2 22 7 28 Z" fill="%2317202a"/><path d="M30 12 Q34 22 25 28 Z" fill="%2317202a"/></svg>`
    };
