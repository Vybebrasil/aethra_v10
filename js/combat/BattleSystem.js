...
(function (Aethra) {
    ...
    Aethra.BattleSystem = {
        ...
        recordHeroAction(action = {}) {
            ...
            return Aethra.BattleLogger.emitBattleLog.apply(this, arguments);
        },
         ...
         */        calculateDamage(defender, options = {}) {
            return Aethra.BattleMath.calculateDamage.apply(this, arguments);
        },        getFloatingTextPosition(result = {}) {
            return Aethra.BattleLogger.getFloatingTextPosition.apply(this, arguments);
        },        emitFloatingCombatText(result) {
            return Aethra.BattleLogger.emitFloatingCombatText.apply(this, arguments);
        },        resolveAttack(attacker, defender, side, options = {}) {
            return Aethra.BattleMath.resolveAttack.apply(this, arguments);
        },        formatAttackMessage(result) {
            return Aethra.BattleLogger.formatAttackMessage.apply(this, arguments);
        },        getAnalyticCombatLogs(result) {
            return Aethra.BattleLogger.getAnalyticCombatLogs.apply(this, arguments);
        },        emitAnalyticCombatLogs(result) {
            return Aethra.BattleLogger.emitAnalyticCombatLogs.apply(this, arguments);
        },        emitAttackResult(result) {
            return Aethra.BattleLogger.emitAttackResult.apply(this, arguments);
        },        emitCombatTick(heroAttack, creatureAttack) {
            return Aethra.BattleLogger.emitCombatTick.apply(this, arguments);
        },
        ...
        summarizeLoot(items = []) {
            ...
            return Aethra.BattleLogger.formatRewardMessage.apply(this, arguments);
        },
        ...
        applyStandaloneGold(gold, creatureId) {
            ...
            return Aethra.BattleMath.rollGold.apply(this, arguments);
        },
